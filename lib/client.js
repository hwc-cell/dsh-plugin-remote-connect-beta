...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.dshRcButton{cursor:pointer;border:none;border-radius:8px;padding:6px 14px;font:inherit;font-weight:500;background:var(--dsw-alias-brand-primary);color:#fff}',
    ...
    exports.internals = { store, setState, api, refresh, act, runCheck, loadSnippet, currentLocale }
