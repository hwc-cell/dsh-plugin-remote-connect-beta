...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const zh = {
      ...
      'key.hint': '口令是本机随机生成的（32 位 URL 安全字符，约 192 位熵），你不需要记住它 —— 它就是链接里的 ?k=。换它不用动服务器。',
    ...
    const en = {
      ...
      'key.hint': 'The password is generated on this machine (32 URL-safe characters, ~192 bits). You never have to remember it — it is the ?k= in the link. Changing it does not touch the server.',
