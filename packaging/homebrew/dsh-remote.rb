...
#        curl -sL https://registry.npmjs.org/dsh-plugin-remote-connect-beta/-/dsh-plugin-remote-connect-beta-0.1.0.tgz | shasum -a 256
...
class DshRemote < Formula
  ...
  homepage "https://github.com/<owner>/dsh-plugin-remote-connect-beta"
  url "https://registry.npmjs.org/dsh-plugin-remote-connect-beta/-/dsh-plugin-remote-connect-beta-0.1.0.tgz"
  sha256 "<sha256>"
  license "MIT"
